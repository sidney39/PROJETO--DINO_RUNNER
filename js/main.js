...
var scoreText={
  ...
  update:function(text){
    ...
    gamearea.context.fillText(text,380,50);
  }
}
var player={
  x:20,
  ...
  update:function(){
    if(this.y<470)
    {
    gamearea.context.drawImage(standimage,this.x,this.y-60,60,60);
    }
    else
    {
    gamearea.context.drawImage(standimage,this.x,this.y-50,50,60);
    } 
  },
  newPos:function(){
    if(this.y<280){
...
var gamearea={
  ...
  stop:function(){
    ...
    gamearea.context.fillStyle="gray";
    gamearea.context.font="45px Consolas";
    gamearea.context.fillText("GAME OVER!!!",300,150);
